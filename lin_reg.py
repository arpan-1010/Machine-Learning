...
x = [140, 163, 175, 180, 143, 150, 155, 159, 179, 192, 200, 212, 219, 145, 234]
y = [37, 63, 65, 66, 59, 60, 62, 67, 70, 71, 72, 75, 80, 68, 70]
...
if ch == 0:
    ...
    #print(n_count)
    eff = (n_count / n) * 100
    print("\nBefore normalization the efficiency of your data is : {}%".format(math.floor(eff)))
    print("------------------------------------------------------------------------------------")
    ...
    if choice == 1:
        ...
        print(df1)
        #calculating efficiency after min-max
        n_minmax, eff_minmax = 0, 0
        for(i, j) in zip(sr1, sr3):
            if(int(i) == int(j)):
                n_minmax += 1
        #print(n_minmax)
        eff_minmax = (n_minmax / n) * 100
        print("\nAfter min-max normalization the efficiency of your data is : {}%".format(math.floor(eff_minmax)))
        print("-------------------------------------------------------------------------------------")
        ...
        print(df3)
        #calculating efficiency after standardization
        n_standard, eff_standard = 0, 0
        for(i, j) in zip(sr1, sr4):
            if(int(i) == int(j)):
                n_standard += 1
        #print(n_standard)
        eff_standard = (n_standard / n) * 100
        print("\nAfter standardization process the efficiency of your data is : {}%".format(math.floor(eff_standard)))
        print("-------------------------------------------------------------------------------------")
        if(eff == eff_minmax) and (eff == eff_standard):
            print("\nAfter normalization process your dataset's efficiency has not increased")
            print("Thus, your dataset is wrong!!")
