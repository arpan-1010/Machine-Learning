...
if ch==0:
    ...
    d1 = {"Income": sr, "Population": sr1, "Predicted value of rice consumption(y)": sr2}
    ...
    #print(eff)
    eff = (n_count / n) * 100
    print("The efficiency of your model is : {}%".format(math.floor(eff)))
    if(eff == 0):
        print("Thus, your dataset is wrong!!")
    else:
        print("The effciency of your model is : {}%".format(math.floor(eff)))
